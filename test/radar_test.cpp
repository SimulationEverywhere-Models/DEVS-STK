...
int main(int argc, char *argv[]){
    ...
    submodels_TOP = {input_reader, radar};
    ...
    eocs_TOP = {
        dynamic::translate::make_EOC<Radar_defs::outDetectedPosition,top_out>("radar")
    };

    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<messageAircraftPosition>::out,Radar_defs::inAircraftPosition>("input_reader","radar")
    };
