...
c2_test.o: test/c2_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) $(INCLUDEDESTIMES) test/c2_test.cpp -o build/c2_test.o
...
tests: ads_test.o aircraft_test.o gunner_test.o radar_test.o c2_test.o missile_test.o message.o engagementUtils.o
	...
	$(CC) -g -o bin/C2_TEST build/c2_test.o build/message.o build/engagementUtils.o
...
# === CONVERTER ===
sim_converter.o: converter/sim_converter.c
	gcc -g -c converter/sim_converter.c -o build/sim_converter.o
		
converter: sim_converter.o
	gcc -g -o bin/SIM_CONVERTER build/sim_converter.o
